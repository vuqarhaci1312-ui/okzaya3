/*! Shopify WebMCP v0.1.0 - 5b357b96eca6cd702260d85b0d49de4598fad5e4 */
(function() {
    let e = [5, 10, 25, 50, 100, 250, 500, 1e3, 2500, 5e3, 1e4];

    function t(e) {
        return Object.keys(e).toSorted().map(t => `${t}\u0000${String(e[t])}`).join(``)
    }
    ...
    function a(e, t, r, i, a) {
        ...
        for (let e of r) {
            ...
            if (e.kind === `counter`) {
                ...
                }, o.set(e.name, n)), n.sum.dataPoints.push({
                    startTimeUnixNano: a,
                    timeUnixNano: i,
                    asDouble: e.value,
                    attributes: t
                ...
                n || (n = {
                ...
                }, s.set(e.name, n)), n.histogram.dataPoints.push({
                    startTimeUnixNano: a,
                    timeUnixNano: i,
                    ...
                    min: e.min,
                    max: e.max,
                    bucketCounts: e.bucketCounts.map(String),
                    explicitBounds: e.bounds,
                    attributes: t
                })
            }
        }
        let c = [...o.values(), ...s.values()];
        return {
            resourceMetrics: [{
                resource: {
                    attributes: [{
    ...
    function o(n) {
        let {
            serviceName: o,
            send: s,
            scopeName: c = `@shopify/webmcp`,
            scopeVersion: l = `0.0.0`,
            flushDelayMs: u = 5e3,
            now: d = Date.now,
            registerLifecycle: f = !1
        } = n, p = new Map, m = d(), h;

        function g() {
            h !== void 0 || typeof setTimeout != `function` || (h = setTimeout(() => {
                h = void 0, _()
            }, u))
        }

        function ee(e, n, r = {}, i = `1`) {
            if (!Number.isFinite(n)) return;
            let a = `c\u0002${e}\u0002${i}\u0002${t(r)}`,
                o = p.get(a);
            o && o.kind === `counter` ? o.value += n : p.set(a, {
                kind: `counter`,
                name: e,
                unit: i,
                attributes: r,
        ...
        function te(n, i, a = {}, o = `1`, s = e) {
            if (!Number.isFinite(i)) return;
            let c = `h\u0002${n}\u0002${o}\u0002${t(a)}`,
                l = p.get(c),
                u;
            l && l.kind === `histogram` ? u = l : (u = {
                kind: `histogram`,
                name: n,
                unit: o,
                attributes: a,
            ...
            }, p.set(c, u)), u.count += 1, u.sum += i, u.min = Math.min(u.min, i), u.max = Math.max(u.max, i), u.bucketCounts[r(u.bounds, i)] += 1, g()
        }

        function _() {
            if (h !== void 0 && (clearTimeout(h), h = void 0), p.size === 0) return;
            let e = d(),
                t = a(o, {
                    name: c,
                    version: l
            ...
            p.clear(), m = e;
            try {
                s(JSON.stringify(t), !0)
            } catch {}
        }
        return f && typeof document < `u` && typeof window < `u` && typeof window.addEventListener == `function` && (document.addEventListener(`visibilitychange`, () => {
            document.visibilityState === `hidden` && _()
    ...
    function l() {
        ...
        return e !== `` && !c[e] && !e.includes(`:`)
    }
    let u = null,
        d = !1;

    function f() {
        return d ? u : (d = !0, l() && (u = o({
            serviceName: `storefront_webmcp`,
            send: s(`https://otlp-http-production.shopifysvc.com/v1/metrics`),
            registerLifecycle: !0
        })), u)
    }
    ...
    function p(e, t = f()) {
        ...
        try {
            t.histogram(`webmcp_tool_call_duration_ms`, r, o, `ms`), t.counter(`webmcp_tool_call_total`, 1, o), i && t.counter(`webmcp_tool_call_errors_total`, 1, {
                tool_name: n,
                error_class: a ? ? `unknown`
            })
        } catch {}
    }

    function m(e) {
        return typeof e == `object` && !!e && typeof Reflect.get(e, `then`) == `function`
    }
    ...
    function g(e) {
        return typeof e == `object` && !!e && Reflect.get(e, `isError`) === !0
    }
    ...
    function ee(e, t, n = f()) {
        return r => {
            ...
            try {
                let e = t(r);
                if (m(e)) return e.then(e => {
                    let t = g(e);
                    return a(t, t ? `tool_error` : void 0), e
                }, e => {
                    throw a(!0, h(e)), e
                });
                let n = g(e);
                return a(n, n ? `tool_error` : void 0), e
            } catch (e) {
                throw a(!0, h(e)), e
            }
        }
    ...
    let te = {
        checkout: () => _(`/checkout`),
        accountOrders: () => _(`/account/orders`),
        product: e => _(`/products/${e}`),
        collection: e => _(`/collections/${e}`),
        search: e => _(`/search?q=${encodeURIComponent(e)}`)
    };

    function _(e) {
        return ne() + (e.startsWith(`/`) ? e.slice(1) : e)
    }

    function v(e) {
        let t = re() ? .match ? .(e);
        if (t ? .route === `product` || t ? .route === `productInCollection`) {
            let e = t.params ? .productHandle;
            if (e) return e
        }
        let n = e.match(/\/products\/([^/?#]+)/);
        return n ? .[1] ? ie(n[1]) : ``
    }
    ...
    let y = {
        ...
        x = {
            ...
            properties: {
                id: {
                    type: `string`,
                    description: `Storefront API ProductVariant GID. Pass to update_cart as line_items[].item.id to add this variant.`
                },
                title: {
                    type: `string`,
        ...
        se = {
            ...
            properties: {
                id: {
                    type: `string`,
                    description: `Cart line GID from get_cart. Pass back to update_cart as line_items[].id to update or remove this line.`
                },
                item: x,
                quantity: {
                    type: `integer`
            ...
            getProduct: {
                ...
                outputSchema: {
                    ...
                    properties: {
                        ...
                        variants: {
                            type: `array`,
                            description: `Resolved variant records. When catalog.selected_options contains a complete option combination, this contains the matching variant. Pass an available variant id to update_cart as line_items[].item.id.`,
                            items: {
                                type: `object`,
                                properties: {
                                    id: {
                                        type: `string`,
                                        description: `Storefront API ProductVariant GID. Pass to show_variant as catalog.variant_id to display it, or update_cart as line_items[].item.id to add it.`
                                    },
                                    title: {
                                        type: `string`
                                    },
            ...
            updateCart: {
                ...
                outputSchema: {
                    ...
                    properties: {
                        ...
                        line_items: {
                            type: `array`,
                            description: `Items added by this mutation, with product/variant details filled in from the post-mutation cart.`,
                            items: S
                        },
                        unresolved_items: {
                            type: `array`
...
`,
    ...
    function le(e) {
        return e ? e.startsWith(`v1_`) ? ue(e.replace(/^v1_/, ``)) : (typeof console < `u` && console.warn(`[hydrogen] Unsupported variant encoding: "${e}"`), []) : []
    }
    ...
    function ue(e) {
        let t = /[ :,-]/g,
            ...
            r;
        for (; r = t.exec(e);) de(e, n, r, t);
        return me(e, n), n.decodedOptions
    }

    function de(e, t, n, r) {
        let i = n[0],
            a = Number.parseInt(e.slice(t.index, n.index), 10) || 0;
        he(t, a), t.currentOptionValue[t.depth] = a, i === `-` ? t.rangeStart = a : i === `:` ? t.depth++ : fe(e, t, n, i), t.index = r.lastIndex
    }

    function fe(e, t, n, r) {
        pe(e, n, r) && t.decodedOptions.push([...t.currentOptionValue]), r === `,` && (t.currentOptionValue.pop(), t.depth--)
    }
    ...
    let C = ((e, t) => {
            ...
            if (t) {
                let e = new Set;
                for (let r of t) e.has(r) || (e.add(r), n += `
` + r)
            }
            return n
        }),
        ...
        O = () => {
            ...
            if (!e ? .getCart || !e.updateCart) throw Error(`Standard Actions are not available. Ensure Shopify Standard Actions are available before calling cart tools.`);
            return e
        },
        k = async (e = O()) => (await e.getCart()).cart ? ? {},
        ge = e => {
            let t = e.userErrors ? .map(e => e.message).filter(Boolean);
            if (t ? .length) throw Error(t.join(`, `))
        },
        _e = e => e.warnings ? .map(e => e.message).filter(F) ? ? [],
        ve = e => e.lines ? .nodes ? ? [],
        A = e => e.totalQuantity ? ? 0,
        j = new Map,
        M = e => {
            ...
            if (n != null) return n;
            try {
                let e = new Intl.NumberFormat(`en`, {
                    style: `currency`,
                    currency: t
        ...
        N = e => {
            ...
            return Number.isFinite(t) ? {
                amount: Math.round(t * 10 ** M(e.currencyCode)),
        ...
        F = e => typeof e == `string` && e.length > 0,
        I = C(`fragment WebMcpMoney on MoneyV2{amount currencyCode}`),
        L = C(`fragment WebMcpProductCard on Product{id title handle vendor productType availableForSale onlineStoreUrl featuredImage{url altText}priceRange{minVariantPrice{...WebMcpMoney}}variantsCount{count}options{name values}}`, [I]),
        R = C(`fragment WebMcpProductForCart on Product{title handle selectedOrFirstAvailableVariant{id title availableForSale}}`),
        ye = C(`fragment WebMcpCartDetails on Cart{id totalQuantity cost{totalAmount{...WebMcpMoney}}lines(first:250){nodes{id quantity cost{totalAmount{...WebMcpMoney}}merchandise{__typename ...on ProductVariant{id title image{url altText}price{...WebMcpMoney}product{id title handle onlineStoreUrl}}}}}}`, [I]),
        z = C(`fragment WebMcpProductDetails on Product{id title handle descriptionHtml vendor productType tags availableForSale onlineStoreUrl featuredImage{url altText}priceRange{minVariantPrice{...WebMcpMoney}maxVariantPrice{...WebMcpMoney}}variantsCount{count}encodedVariantAvailability selectedOrFirstAvailableVariant{...WebMcpProductVariant}options{name values}images(first:20){nodes{url altText}}}`, [C(`fragment WebMcpProductVariant on ProductVariant{id title availableForSale sku price{...WebMcpMoney}compareAtPrice{...WebMcpMoney}selectedOptions{name value}}`, [I])]),
        be = C(`query WebMcpSearchCatalog($query:String!$types:[PredictiveSearchType!]$limit:Int!){predictiveSearch(query:$query types:$types limit:$limit){products{...WebMcpProductCard}collections{title handle description onlineStoreUrl}articles{title handle excerpt onlineStoreUrl}pages{title handle onlineStoreUrl}}}`, [L]),
        xe = C(`query WebMcpSearchPoliciesAndFaqs($query:String!$types:[PredictiveSearchType!]$limit:Int!$includeRefund:Boolean!$includeShipping:Boolean!$includePrivacy:Boolean!$includeTermsOfService:Boolean!$includeTermsOfSale:Boolean!$includeSubscription:Boolean!$includeLegalNotice:Boolean!$includeContact:Boolean!){shop{refundPolicy@include(if:$includeRefund){title body url}shippingPolicy@include(if:$includeShipping){title body url}privacyPolicy@include(if:$includePrivacy){title body url}termsOfService@include(if:$includeTermsOfService){title body url}termsOfSale@include(if:$includeTermsOfSale){title body url}subscriptionPolicy@include(if:$includeSubscription){title body url}legalNotice@include(if:$includeLegalNotice){title body url}contactInformation@include(if:$includeContact){title body url}}predictiveSearch(query:$query types:$types limit:$limit){articles{title handle excerpt onlineStoreUrl}pages{title handle onlineStoreUrl}}}`),
        Se = C(`query WebMcpPageBodies($h1:String$h2:String$h3:String){p1:page(handle:$h1){title body}p2:page(handle:$h2){title body}p3:page(handle:$h3){title body}}`),
        Ce = C(`query WebMcpListCollections($first:Int!){collections(first:$first){nodes{title handle description onlineStoreUrl}}}`),
        we = C(`query WebMcpBrowseProducts($first:Int!$sortKey:ProductSortKeys$reverse:Boolean!){products(first:$first sortKey:$sortKey reverse:$reverse){nodes{...WebMcpProductCard}}}`, [L]),
        Te = C(`query WebMcpBrowseCollectionProducts($handle:String!$first:Int!$sortKey:ProductCollectionSortKeys$reverse:Boolean!){collection(handle:$handle){title handle description onlineStoreUrl products(first:$first sortKey:$sortKey reverse:$reverse){nodes{...WebMcpProductCard}}}}`, [L]),
        Ee = C(`query WebMcpProductByHandle($handle:String!$selectedOptions:[SelectedOptionInput!]!$hasSelectedOptions:Boolean!){product(handle:$handle){...WebMcpProductDetails variantBySelectedOptions(selectedOptions:$selectedOptions caseInsensitiveMatch:true)@include(if:$hasSelectedOptions){...WebMcpProductVariant}}}`, [z]),
        De = C(`query WebMcpProductById($id:ID!$selectedOptions:[SelectedOptionInput!]!$hasSelectedOptions:Boolean!){node(id:$id){__typename ...on Product{...WebMcpProductDetails variantBySelectedOptions(selectedOptions:$selectedOptions caseInsensitiveMatch:true)@include(if:$hasSelectedOptions){...WebMcpProductVariant}}}}`, [z]),
        Oe = C(`query WebMcpProductForCartByHandle($handle:String!){product(handle:$handle){...WebMcpProductForCart}}`, [R]),
        ke = C(`query WebMcpCartDetails($id:ID!){cart(id:$id){...WebMcpCartDetails}}`, [ye]),
        Ae = C(`query WebMcpSearchProductForCart($query:String!){predictiveSearch(query:$query types:[PRODUCT]limit:1){products{...WebMcpProductForCart}}}`, [R]);
    async function je(e, t) {
        return {
            predictiveSearch: Ge((await H(be, {
                query: e,
    ...
    async function Ne(e, t, n) {
        let r = new Set(n),
            i = await H(xe, {
                ...
                types: [`ARTICLE`, `PAGE`],
                limit: t,
                includeRefund: r.has(`refund`),
                includeShipping: r.has(`shipping`),
                includePrivacy: r.has(`privacy`),
                includeTermsOfService: r.has(`terms_of_service`),
                includeTermsOfSale: r.has(`terms_of_sale`),
                includeSubscription: r.has(`subscription`),
                includeLegalNotice: r.has(`legal_notice`),
                includeContact: r.has(`contact`)
            }),
            a = (i.predictiveSearch ? .pages ? ? []).map(gt),
            o = (i.predictiveSearch ? .articles ? ? []).map(ht);
        return {
            policies: Pe(i.shop),
            articles: o,
            pages: await Fe(a)
    ...
    async function Fe(e) {
        let t = e.filter(e => e.handle).slice(0, 3);
        if (!t.length) return e;
        let n = t.map(e => e.handle),
            r = await H(Se, {
                h1: n[0] ? ? null,
                h2: n[1] ? ? null,
                h3: n[2] ? ? null
    ...
    async function Ie() {
        return {
            collections: {
                nodes: (await H(Ce, {
                    first: 50
                })).collections ? .nodes ? .map(W) ? ? []
            }
        }
    }
    async function Le(e) {
        return {
            products: He((await H(we, {
                first: Ve(e.page),
                ...Ue(e.sortBy)
            })).products ? .nodes ? ? [], e.page).map(U),
            title: `All products`
        }
    }
    async function Re(e) {
        let t = e.handle.trim(),
            ...
            r = n.collection ? W(n.collection) : null;
        return {
            collection: r,
            products: He(n.collection ? .products ? .nodes ? ? [], e.page).map(U),
            title: r ? .title ? ? t
        }
    }
    async function V(e, t) {
        let n = _t(e);
        if (!n) return null;
        let r = ft(t.selected_options),
            i = r.length > 0;
        if (vt(n)) {
            let e = (await H(De, {
                id: n,
                selectedOptions: r,
                hasSelectedOptions: i
            })).node;
            return e ? .__typename === `Product` ? ot(U(e), t) : null
        }
        let a = await H(Ee, {
            handle: n,
            selectedOptions: r,
        ...
        return a.product ? ot(U(a.product), t) : null
    }
    async function ze(e, t) {
        ...
        return r ? {
            id: r.id ? ? n,
            item_count: r.totalQuantity ? ? 0,
            total_price: N(r.cost ? .totalAmount),
            currency: r.cost ? .totalAmount ? .currencyCode ? ? ``,
            line_items: (r.lines ? .nodes ? ? []).map(e => Ke(e, t))
        } : null
    }
    async function Be(e) {
        if (e.handle ? .trim()) {
            ...
            return t.product ? Ze(t.product) : null
        }
        if (e.query ? .trim()) {
            let t = (await H(Ae, {
                query: e.query.trim()
            })).predictiveSearch ? .products ? .[0];
            return t ? Ze(t) : null
        }
        return null
    }
    async function H(e, t) {
        let n = await fetch(`/api/2026-04/graphql.json`, {
            method: `POST`,
            headers: {
        ...
        if (!n.ok) throw Error(`Storefront API request failed (${n.status})`);
        let r = await n.json();
        if (r.errors ? .length) throw Error(r.errors.map(e => e.message).filter(Boolean).join(`, `));
        if (!r.data) throw Error(`Storefront API response did not include data.`);
        return r.data
    }

    function Ve(e) {
        return Math.min(Math.max(1, e) * 30, 250)
    }

    function He(e, t) {
        let n = (Math.max(1, t) - 1) * 30;
        return e.slice(n, n + 30)
    }
    ...
    function Ge(e) {
        return {
            products: (e ? .products ? ? []).map(U),
            collections: (e ? .collections ? ? []).map(W),
            articles: (e ? .articles ? ? []).map(rt),
            pages: (e ? .pages ? ? []).map(it)
        }
    }

    function U(e) {
        let t = e.selectedOrFirstAvailableVariant ? tt(e.selectedOrFirstAvailableVariant) : null,
            n = e.variantBySelectedOptions ? tt(e.variantBySelectedOptions) : null;
        return {
            id: e.id,
            title: e.title,
            handle: e.handle,
            ...
            options: Qe(e.options),
            images: et(e.images ? .nodes)
        }
    }
    ...
    function Ke(e, t) {
        return {
            ...
            line_price: N(e.cost ? .totalAmount),
            item: qe(e, t)
        }
    }
    ...
    function Xe(e, t, n) {
        let r = q(e, e => n.product(e));
        if (!r) return ``;
        let i = t.split(`/`).pop();
        return i ? `${r}${r.includes(`?`)?`&`:`?`}variant=${encodeURIComponent(i)}` : r
    }
    ...
    function tt(e) {
        return {
            ...
            sku: e.sku,
            selectedOptions: $e(e.selectedOptions)
        }
    }
    ...
    function G(e, t) {
        ...
        return {
            ...
            handle: n,
            url: at(e, n, t),
            price_range: N(e.priceRange ? .minVariantPrice),
            image: xt(e.featuredImage),
    ...
    function ot(e, t) {
        ...
        return { ...n,
            ...
            tags: e.tags ? ? [],
            price_range: {
                min: N(e.priceRange ? .minVariantPrice),
                max: N(e.priceRange ? .maxVariantPrice)
            },
            variants: o.map(pt),
            available_options: a.options,
            available_options_count: a.count,
            available_options_truncated: a.truncated,
            available_options_filter: i.length ? i : void 0,
            images: e.images ? .map(xt).filter(F) ? ? []
        }
    }
    ...
    function ct(e, t, n) {
        let r = le(t.encodedVariantAvailability),
            i = [];
        for (let t of r) {
            let r = lt(e, t);
            r && ut(r, n) && i.push(r)
        }
        let a = n.length > 0 || i.length <= 50 ? i.slice(0, 50) : [];
        return {
            options: a,
            count: i.length,
            truncated: i.length > a.length
        }
    }
    ...
    function ut(e, t) {
        return t.every(t => e.some(e => dt(e, t)))
    }

    function dt(e, t) {
        return K(e.name) === K(t.name) && K(e.value) === K(t.value)
    }
    ...
    function vt(e) {
        return e.startsWith(`gid://shopify/Product/`)
    }

    function yt(e) {
        return e.handle ? ? v(bt(e.onlineStoreUrl))
    }
    ...
    let St = new Set([`best-selling`, `price-ascending`, `price-descending`, `title-ascending`, `title-descending`, `created-ascending`, `created-descending`]),
        Ct = async (e, t) => {
            try {
                let n = e.collection ? .trim(),
                    r = e.navigate === !0;
                if (!n) return Tt(await Ie(), t.routes, r);
                let i = Math.max(1, Number(e.page) || 1),
                    a = Ot(e.sort_by);
                return Et(n, await wt(n, a, i), a, i, t, r)
            } catch (e) {
                return D(e instanceof Error ? e.message : `Failed to browse store`, `Try browsing without a collection to list available collections.`)
            }
        };
    ...
    function Tt(e, t, n) {
        let r = e.collections ? .nodes ? .map(e => mt(e, t)) ? ? [],
            i = n ? `A collection handle is required to navigate. Ask the user which collection, or call browse_store again with a specific collection handle (or "all") and navigate=true.` : `Call browse_store with a collection handle, or with collection "all" to browse products. Set navigate=true to take the user to the collection page.`;
        return w(`Found ${r.length} collection${r.length===1?``:`s`}.`, {
            collections: r,
            products: [],
            navigated: !1
        }, kt(r), i)
    ...
    function Et(e, t, n, r, i, a) {
        ...
        if (e !== `all` && !t.collection) return D(`Collection "${e}" was not found.`, `Call browse_store without a collection to list available collections.`);
        let s = t.products.map(e => G(e, o)),
            c = o.collection(e),
            l = {
                collections: [],
                products: s,
        ...
        if (a) {
            let e = !Dt(c);
            return e && setTimeout(() => i.navigate(c), 0), E({
                summary: e ? `Showing the ${t.title} collection.` : `Already showing the ${t.title} collection.`,
                navigated: e,
    ...
    function Ot(e) {
        return e && St.has(e) ? e : `best-selling`
    }

    function kt(e) {
        return e.length ? `Collections:\n${e.map(e=>`- ${e.title} (${e.handle})`).join(`
`)}` : null
    }

    function At(e) {
        return e.length ? `Products:\n${e.map(e=>`- ${e.title} (id: ${e.id}, handle: ${e.handle}) - ${P(e.price_range)||`price unavailable`}`).join(`
`)}` : null
    }
    let jt = async () => {
            try {
                let e = O(),
                    t = await k(e),
                    n = A(t);
                if (n === 0) return T(`Cart is already empty.`, {
                    cleared: !0,
                    previous_item_count: 0
                });
                let r = ve(t).filter(e => e.id).map(e => ({
                        id: e.id,
                        quantity: 0
                    })),
                    i = await e.updateCart({
                        lines: r
                    });
                ge(i);
                let a = _e(i),
                    o = a.length ? ` Warnings: ${a.join(`; `)}.` : ``;
                return T(`Cart cleared. Removed ${n} item${n===1?``:`s`}.${o}`, {
                    cleared: !0,
                    previous_item_count: n,
                    ...a.length && {
                        warnings: a
                    }
                }, `The cart has ALREADY been emptied — this result is the authoritative state. Do NOT call cancel_cart or update_cart again for this request.`)
            } catch (e) {
                return D(e instanceof Error ? e.message : `Failed to clear cart`, `Try update_cart with each line_items[].id and quantity 0 to remove items individually.`)
            }
        },
        Mt = async (e, t) => {
            try {
                let e = await k(),
                    n = A(e);
                if (n === 0) return D(`Cart is empty. Add items before checking out.`, `Use search_catalog or update_cart to add products first.`);
                let r = N(e.cost ? .totalAmount),
                    i = t.routes.checkout(),
                    a = !Nt(i);
                a && setTimeout(() => t.navigate(i), 0);
                let o = r ? ` totaling ${P(r)}` : ``;
                return E({
                    summary: a ? `Taken you to checkout with ${n} item${n===1?``:`s`}${o}.` : `Already on the checkout page with ${n} item${n===1?``:`s`}${o}.`,
                    navigated: a,
                ...
                return D(e instanceof Error ? e.message : `Failed to initiate checkout`, `Call get_cart to verify cart contents, then retry.`)
            }
        };
    ...
    let Pt = async (e, t) => {
            try {
                let e = await k();
                return (e.totalQuantity ? ? 0) === 0 || !e.id ? Ft(e) : It(await ze(e.id, t.routes) || Vt(e, t.routes))
            } catch (e) {
                return D(e instanceof Error ? e.message : `Failed to fetch cart`, `Try again - this is usually a transient error.`)
            }
        },
        Ft = e => w(`Cart is empty.`, {
            id: e.id ? ? ``,
            item_count: 0,
            total_price: N(e.cost ? .totalAmount),
            currency: e.cost ? .totalAmount ? .currencyCode ? ? ``,
            line_items: []
        }, null, `Use search_catalog or browse_store to help the user find products to add. Then call update_cart with cart.line_items.`),
        It = e => w(Lt(e), e, Rt(e.line_items), `To modify quantities, call update_cart with the line_items[].id from this response and the new quantity. To remove an item, call update_cart with quantity 0. To proceed, use proceed_to_checkout.`),
        Lt = e => {
            let t = e.line_items.slice(0, 3).map(Bt).join(`, `),
                n = e.line_items.length > 3 ? ` and ${e.line_items.length-3} more` : ``,
                r = e.item_count === 1 ? `` : `s`,
                i = P(e.total_price) || `unknown total`;
            return `Cart has ${e.item_count} item${r} totaling ${i}: ${t}${n}.`
        },
        Rt = e => `Cart line items:
` + e.map(zt).join(`
`),
        zt = e => {
            let t = P(e.line_price) || `price unavailable`;
            return `- ${e.id}: "${Bt(e)}" - ${t}`
        },
        Bt = e => {
            let t = e.item.title || e.item.handle || e.item.id || `item`,
                n = e.item.variant_title;
            return `${t}${n&&n!==`Default Title`?` (${n})`:``} x${e.quantity}`
        };
    ...
    function Vt(e, t) {
        return {
            ...
            total_price: N(e.cost ? .totalAmount),
            currency: e.cost ? .totalAmount ? .currencyCode ? ? ``,
            line_items: (e.lines ? .nodes ? ? []).map(e => ({
                id: e.id ? ? ``,
                quantity: e.quantity ? ? 0,
                line_price: N(e.cost ? .totalAmount),
                item: {
    ...
    let Ht = async (e, t) => {
        let n = e.catalog,
            r = _t(n ? .id) || Jt();
        if (!r) return D(`Product catalog.id is required.`, `Call search_catalog or browse_store to find a product id or handle first.`);
        try {
            return await Ut(r, n, t)
        } catch (e) {
            return D(e instanceof Error ? e.message : `Failed to load product details`, `Try again with a product id or handle from search_catalog or browse_store.`)
        }
    };
    async function Ut(e, t, n) {
        ...
        return a ? t ? .navigate === !0 ? Gt(a, n) : qt(a, !!i ? .length) : Wt(e)
    }

    function Wt(e) {
        return D(`Product "${e}" was not found.`, `Call search_catalog or browse_store to find an available product.`)
    }

    function Gt(e, t) {
        let n = e.url,
            r = !Kt(n);
        return r && setTimeout(() => t.navigate(n), 0), E({
    ...
    function qt(e, t) {
        return w(`${e.title} has ${e.variant_count} variant${e.variant_count===1?``:`s`}.`, e, Yt(e), Xt(e, t))
    }

    function Jt() {
        return typeof window > `u` ? `` : v(window.location.href)
    }

    function Yt(e) {
        if (!e.variants.length) return null;
        let t = e.variants.filter(e => e.availability.available);
        return `Variants:
` + (t.length ? t : e.variants.slice(0, 10)).map(e => {
            let t = e.options.map(e => `${e.name}: ${e.value}`).join(`, `),
                n = P(e.price) || `price unavailable`,
                r = e.availability.available ? `available` : `unavailable`;
            return `- ${e.title} (id: ${e.id}) - ${t||`no options`} - ${n} - ${r}`
        }).join(`
`)
    }

    function Xt(e, t) {
        let n = e.variants.filter(e => e.availability.available),
    ...
    let $t = async (e, t) => {
        ...
        if (!n) return D(`Search query is required.`, `Call search_catalog with catalog.query.`);
        try {
            return tn(n, en((await je(n, sn(Number(e.catalog ? .pagination ? .limit) || 5, 1, 10))).predictiveSearch, t.routes), t.routes)
        } catch (e) {
            return D(e instanceof Error ? e.message : `Search failed`, `Try again with a simpler catalog.query, or use browse_store to inspect collections.`)
        }
    };

    function en(e, t) {
        return {
            products: e.products.map(e => G(e, t)),
            collections: e.collections.map(e => mt(e, t)),
            articles: e.articles.map(ht),
            pages: e.pages.map(gt)
        }
    }
    ...
    function tn(e, t, n) {
        ...
        return r === 0 ? w(`No search results found for "${e}".`, i, null, `Try browse_store to inspect collections or search_catalog with a broader catalog.query.`) : w(`Found ${nn(t).join(`, `)} for "${e}".`, i, an(t), rn(t))
    }

    function nn(e) {
        return [J(`product`, e.products.length), J(`collection`, e.collections.length), J(`article`, e.articles.length), J(`page`, e.pages.length)].filter(Boolean)
    }
    ...
    function rn(e) {
        return e.products.length ? `If the user wants the selected or first available variant, call update_cart with cart.line_items using the product handle or query. If the user requested a specific color, size, material, or other option, call get_product with catalog.id and any known catalog.selected_options to filter available_options, then use the matching variants[].id with update_cart.` : e.collections.length || e.articles.length || e.pages.length ? `No products matched, but other catalog results were found. Share the relevant collection, article, or page URL with the user, or call browse_store for product collections.` : `Use browse_store to inspect products by collection.`
    }

    function an(e) {
        let t = [on(e.products), Y(`Collections`, e.collections), Y(`Articles`, e.articles), Y(`Pages`, e.pages)].filter(Boolean);
...
`) : null
    ...
    function Y(e, t) {
        return t.length ? `${e}:\n` + t.map(e => `- ${e.title}${e.handle?` (${e.handle})`:``}: ${e.url}`).join(`
`) : null
    }
    ...
    let cn = [{
        ...
        ln = async e => {
            let t = e.query ? .trim();
            if (!t) return D(`A search query is required.`, `Call search_shop_policies_and_faqs with a query, e.g. 'return policy' or 'shipping'.`);
            try {
                let e = await Ne(t, 5, un(t));
                return dn(t, e.policies, e.articles, e.pages)
            } catch (e) {
                return D(e instanceof Error ? e.message : `Policy and FAQ search failed`, `Rephrase the query (e.g. 'return policy', 'shipping', 'contact') and try again.`)
            }
        };
    ...
    function un(e) {
        ...
        return t.length ? t : /\bpolic(?:y|ies)\b/i.test(e) ? [...Me] : []
    }
    ...
    function dn(e, t, n, r) {
        ...
        return t.length + n.length + r.length === 0 ? w(`No policies or FAQ content found for "${e}".`, i, null, `The store may not have published this content. Ask the user to rephrase, or share the store's contact page if one exists.`) : w(fn(e, t, n, r), i, pn(t, n, r), mn(t, n, r))
    }
...
` + e.map(e => `- ${e.title}: ${e.url}`).join(`
`) : null, n.length ? `Pages:
` + n.map(e => `- ${e.title}: ${e.url}`).join(`
...
`) : null
    ...
    let hn = async (e, t) => {
        ...
        let {
            ...
            rawVariantId: i,
            selectedOptions: a
        } = n, o = await _n(r, i, a, t);
        if (`error` in o) return o.error;
        let {
            variantId: s,
            resolvedOptions: c
        } = o, l = kn(t.routes.product(r), r, s), u = !An(l);
        return u && setTimeout(() => t.navigate(l), 0), vn({
            handle: r,
            variantId: s,
            url: l,
            navigated: u,
    ...
    function gn(e) {
        let t = e.catalog.variant_id,
            n = Cn(e.catalog.selected_options);
        if (t == null && !n.length) return {
            error: D(`Provide either catalog.variant_id or catalog.selected_options.`, `For a specific variant, pass variant_id from get_product variants[].id. For a partial match like a color only, pass selected_options.`)
        };
        let r = wn(e.catalog.handle);
        return r ? Dn(r) ? {
            handle: r,
            rawVariantId: t ? ? void 0,
            selectedOptions: n
        } : {
            error: D(`Product handle "${r}" is not valid.`, `Use a product handle from search_catalog, browse_store, or get_product.`)
        } : {
            error: D(`Product handle is required.`, `Pass catalog.handle, or call show_variant from a product page.`)
        }
    }
    async function _n(e, t, n, r) {
        ...
        if (n.length) {
            let t = await yn(e, n, r);
            return `error` in t ? t : {
                variantId: t.variantId,
                resolvedOptions: t.options
            }
        }
        return {
            error: D(`Product variant_id could not be resolved.`, `Call get_product to find an available variants[].id, then retry show_variant.`)
        }
    }
    ...
    function vn(e) {
        let {
            ...
            navigated: i,
            resolvedOptions: a
        } = e, o = a ? .length ? ` (${a.map(e=>`${e.name}: ${e.value}`).join(`, `)})` : ``;
        return E({
            summary: i ? `Showing the selected variant${o}.` : `Already showing the selected variant${o}.`,
            navigated: i,
            destination: t,
    ...
    async function yn(e, t, n) {
        try {
            ...
            return r ? bn(r) || await xn(r, e, n) || {
                error: D(`No available variant matched the selected options.`, `Call get_product with the same selected_options to see available_options, then pick one and retry.`)
            } : {
                error: Sn(e)
            }
        } catch (e) {
            return {
                error: D(e instanceof Error ? e.message : `Failed to resolve variant from selected_options.`, `Call get_product first to inspect available variants, then retry show_variant with a variant_id.`)
            }
        }
    }

    function bn(e) {
        let t = e.variants.filter(e => e.availability.available)[0] ? ? e.variants[0];
        return t ? .id ? {
            variantId: X(t.id),
            options: t.options
        } : null
    ...
    async function xn(e, t, n) {
        ...
        let i = await V(t, {
            ...
            a = i ? .variants ? .find(e => e.availability.available) ? ? i ? .variants ? .[0];
        return a ? .id ? {
            variantId: X(a.id),
            options: a.options
        } : null
    ...
    function X(e) {
        let t = String(e).trim();
        if (!t) return ``;
        let n = t.startsWith(`gid://shopify/ProductVariant/`) ? t.slice(29) : t;
        return /^\d+$/.test(n) ? n : ``
    }

    function wn(e) {
        return e ? .trim() ? Tn(e) : En()
    }
    ...
    function kn(e, t, n) {
        let r = new URL(e, jn());
        if (r.searchParams.set(`variant`, n), En() === t) {
            let e = Z().searchParams.get(`selling_plan`);
            e && r.searchParams.set(`selling_plan`, e)
        }
    ...
    let Mn = async (e, t) => {
        ...
        if (!Array.isArray(n) || n.length === 0) return D(`No line_items provided.`, `Call update_cart with cart.line_items.`);
        let r = n.slice(0, 10);
        try {
            let e = await Promise.all(r.map((e, t) => Pn(e ? ? {}, t))),
                n = e.filter(Bn);
            return n.length ? In(n, e, r.length) : await Nn(e.filter(Vn), t)
        } catch (e) {
            return D(e instanceof Error ? e.message : `Cart update failed`, `Call get_cart to verify cart state, then retry update_cart with explicit line_items[].id or line_items[].item.id.`)
        }
    };
    async function Nn(e, t) {
        let n = Un(e);
        if (n && Wn(n)) return Kn();
        let r = await O().updateCart({
            lines: e.map(e => e.type === `update` ? {
                id: e.id,
                quantity: e.quantity
            } : {
        ...
        let i = _e(r),
            a = r.cart ? ? {},
            o = N(a.cost ? .totalAmount),
            s = await Ln(e.filter(Q), a.id, t.routes);
        return T(zn(e, A(a), o, i), {
            updated: !0,
            item_count: A(a),
            total_price: o,
            line_items: s,
            warnings: i.length ? i : void 0
        }, `This change has ALREADY been applied — the item_count and total in this result are the authoritative post-update cart state. Do NOT call update_cart again for this request: adds are cumulative, so repeating the call adds duplicate items or re-applies quantity changes. If you need to confirm, read the values in this result instead of re-running the mutation.`)
    }
    async function Pn(e, t) {
        let n = Fn(e.quantity, !!e.id);
        if (e.id) return {
            type: `update`,
            id: e.id,
            quantity: n
        ...
        return r ? {
            type: `add`,
            merchandiseId: r.variant.merchandise_id,
            quantity: n,
    ...
    function Fn(e, t) {
        let n = Number(e);
        return Number.isFinite(n) ? Math.max(+!t, Math.floor(n)) : 1
    }

    function In(e, t, n) {
        let r = t.filter(Q),
            i = e.map(e => `- Item ${e.item}: ${e.reason}`).join(`
`);
        return w(`Need clarification for ${e.length} of ${n} line_item${n===1?``:`s`}. Nothing changed.`, {
            updated: !1,
            unresolved_items: e,
            resolved_items: r.map(Rn)
        }, i, `Call search_catalog or get_product to find explicit product or variant ids, then call update_cart again. For specific variant requests, prefer line_items[].item.id from get_product variants[].id.`)
    }
    async function Ln(e, t, n) {
        ...
        if (!i) return r;
        let a = new Map;
        for (let e of i.line_items) e.item.id && a.set(e.item.id, e);
        return e.map((e, t) => {
            let n = a.get(e.merchandiseId);
            return n ? {
                item: n.item,
                quantity: n.quantity,
    ...
    function zn(e, t, n, r) {
        let i = e.filter(Q),
            a = e.filter(Hn),
            o = i.reduce((e, t) => e + t.quantity, 0),
            s = [];
        i.length && s.push(`Added ${o} item${o===1?``:`s`} across ${i.length} product${i.length===1?``:`s`}`), a.length && s.push(`updated ${a.length} line${a.length===1?``:`s`}`);
        let c = `Cart now has ${t} item${t===1?``:`s`}${n?` totaling ${P(n)}`:``}.`,
            l = r.length ? ` Warnings: ${r.join(`; `)}.` : ``;
        return `${s.join(` and `)}. ${c}${l}`
    }
    ...
    function Un(e) {
        if (!e.some(Q)) return null;
        let t = e.map(e => e.type === `add` ? `a:${e.merchandiseId}:${e.quantity}` : `u:${e.id}:${e.quantity}`).toSorted();
        return JSON.stringify(t)
    }

    function Wn(e) {
        return $ !== null && $.signature === e && Date.now() - $.at < 5e3
    }
    ...
    function Kn() {
        return w(`An identical add was just applied — the cart already includes these items, so I did not add them again (this prevents accidental duplicates).`, {
            updated: !1,
            deduped: !0
        }, null, `If the shopper truly wants MORE of the same item, call update_cart again with a higher quantity, or call get_cart and set the line's quantity by line_items[].id. Otherwise do NOT repeat this call — the previous update already succeeded.`)
    }
    let qn = {
            browse_store: Ct,
            cancel_cart: jt,
            proceed_to_checkout: Mt,
            get_cart: Pt,
            get_product: Ht,
            manage_orders: Zt,
            search_catalog: $t,
            search_shop_policies_and_faqs: ln,
            show_variant: hn,
            update_cart: Mn
        },
        Jn = Symbol.for(`shopify.webmcp.registered`),
        Yn = Object.values(ce).map(e => ({ ...e,
            execute: qn[e.name]
        }));
    ...
    function Xn() {
        ...
        for (let r of Yn) {
            let i = tr(r, t);
            n.push(e.registerTool(i))
        }
        return er(), Promise.allSettled(n), !0
    }

    function Zn(e) {
        let t = window.Shopify ? .navigate;
        if (t) return t(e);
    ...
    function $n() {
        return typeof window > `u` ? !1 : Reflect.get(window, Jn) === !0
    }

    function er() {
        typeof window > `u` || Reflect.set(window, Jn, !0)
    }
    ...
    function tr(e, t) {
        ...
        return { ...r,
            execute: ee(e.name, e => n(e, t))
        }
    }(function() {
        typeof window > `u` || Xn()
    })()
})();
//# sourceMappingURL=webmcp-0.1.0.js.map